...
VLINX — это браузерное расширение для Google Chrome и Opera, позволяющее быстро настроить VPN-соединение через Xray. Расширение поднимает локальный SOCKS5-прокси и гибко маршрутизирует трафик по доменам.

## Интерфейс расширения

### Главный экран
![Главный экран](./images/1_home.png)

### Добавление ключа
![Добавление ключа](./images/2_insert_key.png)

### Управление доменами
![Управление доменами](./images/3_manage_domains.png)
...
## Примечания
- С версии 3.0 расширение поддерживает:
  - подключение через VLESS-ключ;
  - подключение через готовую JSON-конфигурацию Xray.
